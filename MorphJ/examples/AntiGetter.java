...
class AllGetters<class T> {
	...
	<R,A*,E*>[m] for(R get_#m(A) throws E : T.methods)
...
public class AntiGetter<class T> {
	...
	<R,A*,E*>[m] for(R m(A) throws E : T.methods; no R m(A) throws E : AllGetters<T>.methods)
	public R m(A args) {
		 return instance.m(args);
	}
	public static void main(String argv[]) {
		 AntiGetter<Foo> baz = new AntiGetter<Foo>();
