...
public class DoubleLiteral extends Literal implements Cloneable {
    ...
    // Declared in TypeCheck.jrag at line 573
 ...
 public void typeCheck() {
   ...
   if(constant().doubleValue() == Double.NEGATIVE_INFINITY || constant().doubleValue() == Double.POSITIVE_INFINITY)
    ...
    // Declared in CodeGeneration.jrag at line 535


  public void emitPushConstant(CodeGeneration gen) {
    if(constant().doubleValue() == 0) gen.emit(Bytecode.DCONST_0);
    else if(constant().doubleValue() == 1) gen.emit(Bytecode.DCONST_1);
    else {
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in ConstantExpression.jrag at line 259
