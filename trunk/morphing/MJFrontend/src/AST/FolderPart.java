...
import java.util.HashSet;import java.util.LinkedHashSet;import java.io.File;import java.util.*;import beaver.*;import java.util.ArrayList;import java.util.zip.*;import java.io.*;import java.io.FileNotFoundException;import java.util.Collection;
  ...
  public class FolderPart extends PathPart {
    // Declared in ClassPath.jrag at line 355
    private HashMap map = new HashMap();

    // Declared in ClassPath.jrag at line 356
    private File folder;

    // Declared in ClassPath.jrag at line 358

    public FolderPart(File folder) {
      this.folder = folder;
    }

    // Declared in ClassPath.jrag at line 362
    ...
    // Declared in ClassPath.jrag at line 375
