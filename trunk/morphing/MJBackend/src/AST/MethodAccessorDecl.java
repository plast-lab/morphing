...
public class MethodAccessorDecl extends MethodDecl implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        MethodAccessorDecl node = (MethodAccessorDecl)super.clone();
    ...
    public ASTNode copy() {
      try {
          MethodAccessorDecl node = (MethodAccessorDecl)clone();
    ...
    public ASTNode fullCopy() {
        MethodAccessorDecl res = (MethodAccessorDecl)copy();
    ...
    // Declared in InnerClasses.jrag at line 254
  ...
  public void emitInvokeMethod(CodeGeneration gen, TypeDecl hostType) {
    ...
    // Declared in Java2Transformations.ast at line 3
    // Declared in Java2Transformations.ast line 1

    public MethodAccessorDecl() {
        super();
    ...
    // Declared in Java2Transformations.ast at line 16


    // Declared in Java2Transformations.ast line 1
    public MethodAccessorDecl(Modifiers p0, Access p1, String p2, List p3, List p4, List p5, Opt p6) {
        setChild(p0, 0);
        setChild(p1, 1);
        setID(p2);
        setChild(p3, 2);
    ...
    // Declared in Java2Transformations.ast at line 26
  ...
  protected int numChildren() {
    ...
    // Declared in Java2Transformations.ast at line 29
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in InnerClasses.jrag at line 242
    ...
    // Declared in InnerClasses.jrag at line 266
    public int flags() {
        if(flags_computed)
            return flags_value;
        int num = boundariesCrossed;
    ...
    private int flags_compute() {  return  (super.flags() | Modifiers.ACC_STATIC) & (~Modifiers.ACC_PRIVATE);  }
