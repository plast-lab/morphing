...
public class LongLiteral extends Literal implements Cloneable {
 ...
 public void typeCheck() {
   if(constant().error)
    ...
    // Declared in CodeGeneration.jrag at line 526


  public void emitPushConstant(CodeGeneration gen) {
    if(constant().longValue() == 0) gen.emit(Bytecode.LCONST_0);
    else if(constant().longValue() == 1) gen.emit(Bytecode.LCONST_1);
    else {
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in ConstantExpression.jrag at line 207
    ...
    // Declared in ConstantExpression.jrag at line 208
    ...
    // Declared in ConstantExpression.jrag at line 209
