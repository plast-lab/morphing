...
public class GEExpr extends RelationalExpr implements Cloneable {
  ...
  public void printOp(StringBuffer s) {
    ...
    // Declared in CreateBCode.jrag at line 1218

  public void compareBranch(CodeGeneration gen, int label, TypeDecl typeDecl) { typeDecl.branchGE(gen, label); }

    // Declared in CreateBCode.jrag at line 1228

  public void compareNotBranch(CodeGeneration gen, int label, TypeDecl typeDecl) { typeDecl.branchLT(gen, label); }

    // Declared in java.ast at line 3
    // Declared in java.ast line 183
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in ConstantExpression.jrag at line 503
