...
public class AnnotationMethodDecl extends MethodDecl implements Cloneable {
    ...
    // Declared in Annotations.jrag at line 148
  ...
  public void typeCheck() {
    ...
    // Declared in Annotations.ast line 3
    public AnnotationMethodDecl(Modifiers p0, Access p1, String p2, List p3, List p4, List p5, Opt p6, Opt p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setID(p2);
        setChild(p3, 2);
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    public Opt getDefaultValueOptNoTransform() {
        return (Opt)getChildNoTransform(6);
    }
