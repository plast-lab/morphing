...
import java.util.HashSet;import java.util.LinkedHashSet;import java.io.File;import java.util.*;import beaver.*;import java.util.ArrayList;import java.util.zip.*;import java.io.*;import java.io.FileNotFoundException;import java.util.Collection;
  ...
  public class Constraints extends java.lang.Object {
    // Declared in GenericMethodsInference.jrag at line 84
    ...
    // Declared in GenericMethodsInference.jrag at line 90
    private Collection typeVariables;

    // Declared in GenericMethodsInference.jrag at line 91
    private Map constraintsMap;

    // Declared in GenericMethodsInference.jrag at line 93
    ...
    // Declared in GenericMethodsInference.jrag at line 115
    ...
    // Declared in GenericMethodsInference.jrag at line 136
    ...
    // Declared in GenericMethodsInference.jrag at line 149
    ...
    // Declared in GenericMethodsInference.jrag at line 175
    ...
    // Declared in GenericMethodsInference.jrag at line 183
    ...
    // Declared in GenericMethodsInference.jrag at line 193
    ...
    // Declared in GenericMethodsInference.jrag at line 201

    public void resolveSubtypeConstraints() {
      for(Iterator iter = typeVariables.iterator(); iter.hasNext(); ) {
        TypeVariable T = (TypeVariable)iter.next();
        ConstraintSet set = (ConstraintSet)constraintsMap.get(T);
        if(!set.subtypeConstraints.isEmpty()) {
          ArrayList list = set.subtypeConstraints;
          if(list.size() == 1)
            set.typeArgument = (TypeDecl)list.iterator().next();
          else
            throw new Error("Need to compute greatest lower bound for subtype constraints");
        }
      }
    }

    // Declared in GenericMethodsInference.jrag at line 215
    ...
    // Declared in GenericMethodsInference.jrag at line 267
    ...
    */
    ...
    private HashSet directSupertypes(TypeDecl t) {
    ...
    private HashSet parameterizedSupertypes(TypeDecl t) {
    ...
    private void addParameterizedSupertypes(TypeDecl t, HashSet processed, HashSet result) {
    ...
    // Declared in GenericMethodsInference.jrag at line 312
    ...
    // Declared in GenericMethodsInference.jrag at line 332
    ...
    // Declared in GenericMethodsInference.jrag at line 427
    ...
    // Declared in GenericMethodsInference.jrag at line 549
