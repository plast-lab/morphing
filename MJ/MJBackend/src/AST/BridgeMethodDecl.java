...
public class BridgeMethodDecl extends MethodDecl implements Cloneable {
    ...
    // Declared in GenericsCodegen.jrag at line 209


  public void java2Transformation() { }

    // Declared in Generics.ast at line 3
    // Declared in Generics.ast line 37
    ...
    // Declared in Generics.ast line 37
    public BridgeMethodDecl(Modifiers p0, Access p1, String p2, List p3, List p4, List p5, Opt p6) {
        setChild(p0, 0);
        setChild(p1, 1);
        setID(p2);
        setChild(p3, 2);
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in GenericsCodegen.jrag at line 212
    public int flags() {
        if(flags_computed)
            return flags_value;
